...
// ---------- Effects ---------- //
#include "effects/fade_black.h" // AUTOGENERATED
#include "effects/rainbow_wave.h" // AUTOGENERATED
#include "effects/set_brightness.h" // AUTOGENERATED
#include "effects/solid_color.h" // AUTOGENERATED
// ---------- Effects ---------- //
...
CRGBArray<STRIP_PHYSICAL_LEDS_0> strip_0; // AUTOGENERATED

// Array for each led and associated hue values for use in effects
CRGBSet led_array_0(strip_0(0, LED_NUM_0 - 1)); // AUTOGENERATED
uint8_t led_hues_0[LED_NUM_0]; // AUTOGENERATED
uint8_t led_args_0[ARGS_NUM]; // AUTOGENERATED

CRGBSet led_array_1(strip_0(LED_NUM_0, LED_NUM_0 + LED_NUM_1 - 1)); // AUTOGENERATED
uint8_t led_hues_1[LED_NUM_1]; // AUTOGENERATED
uint8_t led_args_1[ARGS_NUM]; // AUTOGENERATED

// Store all relevant information about each LED strip
LEDDict strips[]{
    {led_array_0, led_hues_0, led_args_0, LED_NUM_0, 0, 0, 0, LED_DELAY_0, false}, // AUTOGENERATED
    {led_array_1, led_hues_1, led_args_1, LED_NUM_1, 0, 0, 0, LED_DELAY_1, false}}; // AUTOGENERATED
// ---------- LED Definitions ---------- //
...
void setup()
{
  ...
  delay(2000);
  // ---------- Strip Init ---------- //
  FastLED.addLeds<STRIP_PHYSICAL_TYPE_0, STRIP_PHYSICAL_PIN_0, STRIP_PHYSICAL_ORDER_0>(strip_0, STRIP_PHYSICAL_LEDS_0); // AUTOGENERATED
  // ---------- Strip Init ---------- //
  // Begin serial
